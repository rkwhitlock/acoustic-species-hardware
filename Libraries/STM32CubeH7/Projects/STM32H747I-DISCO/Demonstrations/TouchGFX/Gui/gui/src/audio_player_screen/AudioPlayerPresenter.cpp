...
bool AudioPlayerPresenter::fileAdded(uint32_t index)
{
    ...
    strncat(playlist[pl_index].filename, dirlist[index].name, sizeof(playlist[pl_index].filename) - 1);
    playlist[pl_index].used = true;
    playlist[pl_index].bmpId = BITMAP_COVER_UNKNOWN_ARTIST_ID;
...
void AudioPlayerPresenter::oneSecond()
{
    ...
    case 6:
        ...
        view.screenClick(ClickEvent::PRESSED, 400, 240);
        break;
    case 8:
        view.screenClick(ClickEvent::RELEASED, 400, 240);
        break;
    case 28:
        view.screenClick(ClickEvent::PRESSED, 660, 240);
        break;
    case 30:
        view.screenClick(ClickEvent::RELEASED, 660, 240);
        break;
    case 32:
        view.screenClick(ClickEvent::PRESSED, 660, 240);
        break;
    ...
    case 38:
        ...
        break;
    case 50:
        view.screenClick(ClickEvent::PRESSED, 621, 440);
        break;
    case 52:
        view.screenClick(ClickEvent::RELEASED, 621, 440);
        break;
    case 58:
        view.screenClick(ClickEvent::PRESSED, 90, 117);
        break;
    case 63:
        view.screenClick(ClickEvent::RELEASED, 90, 117);
        break;
    case 68:
        view.screenClick(ClickEvent::PRESSED, 685, 440);
        break;
    case 70:
          view.screenClick(ClickEvent::RELEASED, 685, 440);
        break;
    case 72:
        slideCnt = -7;
        break;
