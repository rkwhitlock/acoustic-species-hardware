...
The STM32 H7 STemWin demonstration is running on STM32H747I-DISCO boards 
...
@par Hardware and Software environment
  ...
  - This demonstration runs on STM32H747xx/STM32H753xx devices.
    
  - This demonstration has been tested with STMicroelectronics STM32H747I-DISCO
...
1- Open STM32CubeProgrammer, click on setting icon from the bar menu then check 
   "MT25TL01G_STM32H7xxI-DISCO" box 
2- Connect the STM32H747I-DISCO board to PC with USB cable through CN2
3- Use "STM32CubeDemo_STM32H747I-DISCO_VX.Y.Z.hex" file provided under “Binary” with STM32CubeProgrammer
...
5- Plug/connect the Media storage: SDCard on CN12 connector or USB on CN1 connector.
