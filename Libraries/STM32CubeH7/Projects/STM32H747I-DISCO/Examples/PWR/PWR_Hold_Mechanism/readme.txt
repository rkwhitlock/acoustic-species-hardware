...
After a system wake up from STOP mode following the RTC timer interrupt (i.e after 20 sec):
  ...
  If scenario 2 is selected (CM7_HOLD_TEST) then:
    ...
    is released and woken up from STOP mode.
    When CM7 core is woken up from STOP mode the system clock is reconfigured since 
    the default system clock source after wake up from STOP mode is the HSI. 
...
System, Power, PWR, multiprocessor, Hold Mechanism, Release, Master CPU, Slave CPU, Stop mode, RTC, Interrupt, Wakeup, Low Power
...
@par Directory contents 
  ...
  - PWR/PWR_Hold_Mechanism/CM4/Src/stm32h7xx_hal_msp.c      HAL MSP module
