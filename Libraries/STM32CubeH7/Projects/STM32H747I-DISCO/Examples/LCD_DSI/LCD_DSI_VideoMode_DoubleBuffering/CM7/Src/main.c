/**
  ******************************************************************************
  * @file    LCD_DSI/LCD_DSI_VideoMode_DoubleBuffering/CM7/Src/main.c
  * @author  MCD Application Team
  * @brief   This example describes how to configure and use LCD DSI in Video mode to display an image
  *          of size WVGA in mode landscape (800x480 for LCD DSI Screen or 720x576 for HDMI monitor ) 
  *          using the STM32H7xx HAL API and BSP.
...
static void LCD_BriefDisplay(void)
{
  ...
  UTIL_LCD_DisplayStringAt(0,LINE(2) , (uint8_t *)"LCD_DSI_VideoMode_DoubleBuffering", CENTER_MODE);
  UTIL_LCD_SetFont(&Font16);
  UTIL_LCD_DisplayStringAt(0,LINE(5), (uint8_t *)"This example shows how to display images on LCD DSI", CENTER_MODE);
  UTIL_LCD_DisplayStringAt(0,LINE(6), (uint8_t *)"using two buffers one for display and the other for draw", CENTER_MODE);   
