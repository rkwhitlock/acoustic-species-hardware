...
static void LCD_BriefDisplay(void)
{
  ...
  UTIL_LCD_DisplayStringAtLine(1, (uint8_t *)"        LCD_DSI_CmdMode_PartialRefresh");
  UTIL_LCD_SetFont(&Font16);
  UTIL_LCD_DisplayStringAtLine(4, (uint8_t *)"This example shows how to display images on LCD DSI using the partial");
  UTIL_LCD_DisplayStringAtLine(5, (uint8_t *)"Refresh method by splitting the display area.");
}
