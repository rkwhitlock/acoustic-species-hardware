/**
  ...
  * @brief   This example describes how to configure and use LCD DSI in Adapted command mode to display an image
  *          of size WVGA in mode landscape (800x480) using the STM32H7xx HAL API and BSP.
