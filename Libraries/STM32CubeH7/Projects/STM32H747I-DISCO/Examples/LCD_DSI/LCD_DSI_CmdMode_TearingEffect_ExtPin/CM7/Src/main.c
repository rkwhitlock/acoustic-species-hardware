/**
  ******************************************************************************
  * @file    LCD_DSI/LCD_DSI_CmdMode_TearingEffect_ExtPin/CM7/Src/main.c
  * @author  MCD Application Team
  * @brief   This example describes how to configure and use LCD DSI to display
  *          on LCD KoD in mode DSI Adapted command mode using using Ext GPIO as anti-tearing trigger
...
/** @addtogroup LCD_DSI_CmdMode_TearingEffect_ExtPin
  * @{
  */
