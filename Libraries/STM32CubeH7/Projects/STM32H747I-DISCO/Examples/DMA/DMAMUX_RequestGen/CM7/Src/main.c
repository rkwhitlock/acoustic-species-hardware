...
uint32_t SRC_Buffer_LED4_Toggle[2]  =
                                      {  0xFFFF & (~LED4_PIN), /*Value for LED 4 ON  */
                                         0xFFFF                /*Value for LED 4 OFF */
                                      };
#elif defined ( __CC_ARM )
ALIGN_32BYTES(__attribute__((section (".RAM_D3"))) uint32_t SRC_Buffer_LED4_Toggle[2]) =
                                      {  0xFFFF & (~LED4_PIN), /*Value for LED 4 ON  */
                                         0xFFFF                /*Value for LED 4 OFF */
                                      };
#elif defined ( __GNUC__ )
ALIGN_32BYTES(uint32_t __attribute__((section (".RAM_D3"))) SRC_Buffer_LED4_Toggle[2])  =
                                      {  0xFFFF & (~LED4_PIN), /*Value for LED 4 ON  */
                                         0xFFFF                /*Value for LED 4 OFF */
                                      };
#endif
...
int main(void)
{
  ...
  */
  ...
  /* DMA source buffer is  SRC_BUFFER_LED4_TOGGLE containing values to be written
  to GPIOI ODR register in order to turn LED4 On/Off each time comes a request from the DMAMUX request generator */
  HAL_DMA_Start_IT(&DMA_Handle, (uint32_t)SRC_Buffer_LED4_Toggle, (uint32_t)&GPIOI->ODR, 2);
