...
using the JPEG HW decoder in polling mode and display the final ARGB8888 image 
on KoD DSI-LCD mounted on board or a HDMI monitor Connected through the DSI-HDMI bridge board MB1232.A.
...
Display, Graphics, JPEG, Decoding, Flash memory, DSI, LTDC, DMA2D, Polling, ARGB8888, Hardware decoding, LCD, YCbCr, RGB, HDMI
FatFS, File system, SD Card, SDRAM

@par Directory contents

  - JPEG/JPEG_DecodingUsingFs_Polling/Common/Src/system_stm32h7xx.c     STM32H7xx system configuration source file  
  
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Inc/stm32h7xx_hal_conf.h          HAL configuration file for Cortex-M7
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Inc/stm32h7xx_it.h                Interrupt handlers header file for Cortex-M7
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Inc/main.h                        Header for main.c module for Cortex-M7  
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Inc/ffconf.h                      FAT file system module configuration file
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Inc/decode_polling.h              Header for decode_polling.c module
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Inc/sd_diskio.h                   Header for sd_diskio.c module  
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Src/stm32h7xx_it.c                Interrupt handlers for Cortex-M7
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Src/main.c                        Main program for Cortex-M7
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Src/stm32h7xx_hal_msp.c           HAL MSP module for Cortex-M7  
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Src/decode_polling.c              JPEG Decoding with polling module
  - JPEG/JPEG_DecodingUsingFs_Polling/CM7/Src/sd_diskio.c                   SD Disk I/O driver module    

  - JPEG/JPEG_DecodingUsingFs_Polling/CM4/Inc/stm32h7xx_hal_conf.h          HAL configuration file for Cortex-M4
  - JPEG/JPEG_DecodingUsingFs_Polling/CM4/Inc/stm32h7xx_it.h                Interrupt handlers header file for Cortex-M4
  - JPEG/JPEG_DecodingUsingFs_Polling/CM4/Inc/main.h                        Header for main.c module for Cortex-M4  
  - JPEG/JPEG_DecodingUsingFs_Polling/CM4/Src/stm32h7xx_it.c                Interrupt handlers for Cortex-M4
  - JPEG/JPEG_DecodingUsingFs_Polling/CM4/Src/main.c                        Main program for Cortex-M4
  - JPEG/JPEG_DecodingUsingFs_Polling/CM4/Src/stm32h7xx_hal_msp.c           HAL MSP module for Cortex-M4  
