...
located on the uSD and display the final ARGB8888 video on KoD DSI-LCD
...
Display, Graphics, JPEG, MJPEG, Video, Decoding, LCD, LTDC, DSI, DMA2D, JPEG Hardware Decoder, HDMI
DMA, FatFS, File system, avi, YCbCr, RGB

@par Directory contents

  - JPEG/JPEG_MJPEG_VideoDecoding/Common/Src/system_stm32h7xx.c     STM32H7xx system configuration source file

  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Inc/stm32h7xx_hal_conf.h          HAL configuration file for Cortex-M7
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Inc/stm32h7xx_it.h                Interrupt handlers header file for Cortex-M7
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Inc/main.h                        Header for main.c module for Cortex-M7
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Inc/ffconf.h                      FAT file system module configuration file
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Inc/decode_dma.h                  Header for decode_dma.c module
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Inc/sd_diskio.h                   Header for sd_diskio.c module
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Inc/AVI_parser.h                  Header for AVI_parser.c module
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Src/stm32h7xx_it.c                Interrupt handlers for Cortex-M7
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Src/stm32h7xx_hal_msp.c           HAL MSP module for Cortex-M7
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Src/main.c                        Main program for Cortex-M7
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Src/decode_dma.c                  JPEG Decoding with MDMA module
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Src/sd_diskio.c                   SD Disk I/O driver module
  - JPEG/JPEG_MJPEG_VideoDecoding/CM7/Src/AVI_parser.c                  AVI parser module

  - JPEG/JPEG_MJPEG_VideoDecoding/CM4/Inc/stm32h7xx_hal_conf.h          HAL configuration file for Cortex-M4
  - JPEG/JPEG_MJPEG_VideoDecoding/CM4/Inc/stm32h7xx_it.h                Interrupt handlers header file for Cortex-M4
  - JPEG/JPEG_MJPEG_VideoDecoding/CM4/Inc/main.h                        Header for main.c module for Cortex-M4
  - JPEG/JPEG_MJPEG_VideoDecoding/CM4/Src/stm32h7xx_it.c                Interrupt handlers for Cortex-M4
  - JPEG/JPEG_MJPEG_VideoDecoding/CM4/Src/stm32h7xx_hal_msp.c           HAL MSP module for Cortex-M4
  - JPEG/JPEG_MJPEG_VideoDecoding/CM4/Src/main.c                        Main program for Cortex-M4
...
@par Hardware and Software environment
  ...
  - Copy an MJPEG video file to the uSD card (under the root)
      The file must have the following properties:
        ...
        - Height : if using DSI-LCD <= 480, if using DSI-HDMI <= 576
      The MJPEG file can be in “AVI” container format.
  - Connect the uSD Card to the Micro SD connector (CN12).
