/**
  ******************************************************************************
  * @file    JPEG/JPEG_DecodingUsingFs_Interrupt/CM7/Src/main.c
  * @author  MCD Application Team
  * @brief   This sample code shows how to use the HW JPEG to Decode a JPEG file with IT method.
  ...
  if(FATFS_LinkDriver(&SD_Driver, SDPath) == 0)
  {
    ...
    {    
      ...
      if(f_mount(&SDFatFs, (TCHAR const*)SDPath, 0) == FR_OK)
      {
        ...
        {
          /*##-7- JPEG decoding with IT model (Not Blocking ) Method ###########*/
...
static void LCD_BriefDisplay(void)
{
  ...
  UTIL_LCD_DisplayStringAt(0, LINE(2), (uint8_t *)"JPEG Decoding from uSD Fatfs with IT", CENTER_MODE);
  UTIL_LCD_SetFont(&Font16);
  UTIL_LCD_DisplayStringAt(0, LINE(5), (uint8_t *)"This example shows how to Decode (with IT model)", CENTER_MODE);
