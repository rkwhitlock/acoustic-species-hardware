...
In this application:
    ...
    - Each CPU request the UART2 resource in a loop:
...
@par Directory contents
    ...
    - ResourcesManager/ResourcesManager_SharedResources/Common/Src/stm32h7xx_hal_msp.c  The MSP for Cortex-M7 and Cortex-M4
