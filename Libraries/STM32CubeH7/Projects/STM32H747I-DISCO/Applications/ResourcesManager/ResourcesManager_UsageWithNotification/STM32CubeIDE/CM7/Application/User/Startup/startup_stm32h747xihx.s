...
/* start address for the .data_RAM_D3 section. defined in linker script */
.word _sdata_RAM_D3
/* end address for the .data_RAM_D3 section. defined in linker script */
.word _edata_RAM_D3
/* start address for the .bss_RAM_D3 section. defined in linker script */
.word _sbss_RAM_D3
/* end address for the .bss_RAM_D3 section. defined in linker script */
.word _ebss_RAM_D3
/* start address for the .data_CPU_MSG section. defined in linker script */
.word _sdata_CPU_MSG
/* end address for the .data_CPU_MSG section. defined in linker script */
.word _edata_CPU_MSG
/* start address for the .bss_CPU_MSG section. defined in linker script */
.word _sbss_CPU_MSG
/* end address for the .bss_CPU_MSG section. defined in linker script */
.word _ebss_CPU_MSG
/* start address for the .data_UartHandle section. defined in linker script */
.word _sdata_UartHandle
/* end address for the .data_UartHandle section. defined in linker script */
.word     _edata_UartHandle
/* start address for the .bss_CPU_MSG section. defined in linker script */
.word     _sbss_UartHandle
/* end address for the .bss_UartHandle section. defined in linker script */
.word     _ebss_UartHandle
...
/* Copy the data segment initializers from flash to SRAM */
  ...
  INIT_DATA _sdata_RAM_D3, _edata_RAM_D3, _sidata_RAM_D3
  INIT_DATA _sdata_CPU_MSG, _edata_CPU_MSG, _sidata_CPU_MSG
  INIT_DATA _sdata_UartHandle, _edata_UartHandle, _sidata_UartHandle


/* Zero fill the bss segment. */
  INIT_BSS _sbss, _ebss
  INIT_BSS _sbss_RAM_D3, _ebss_RAM_D3
  INIT_BSS _sbss_CPU_MSG, _ebss_CPU_MSG
  INIT_BSS _sbss_UartHandle, _ebss_UartHandle
