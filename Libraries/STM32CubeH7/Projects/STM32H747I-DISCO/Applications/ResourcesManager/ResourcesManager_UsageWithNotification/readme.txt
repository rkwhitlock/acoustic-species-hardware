...
It presents also how we can use a request in pending mode and how we can inherate the context of the resource driver. 
...
STM32H747I_DISCO board's LEDs and Uart messages can be used to monitor the execution status:
    - CM7 using the the UART2 resource:
      * LED1 ON during 1 Seconde.
      * UART message will be print the UART Terminal:"This Message is from CM7 Core"
    - CM4 using the the UART2 resource:
...
STM32H747I_DISCO board's USART2 is coonected to USB Virtual Com Port (VCP):
...
ResourcesManager, multiprocessor, Resource share, Dual, Request, Pending mode, Inherite, Notification
...
@par Directory contents
    ...
    - ResourcesManager/ResourcesManager_UsageWithNotification/CM7/Inc/main.h                  Header for main.c module for Cortex-M7  
    - ResourcesManager/ResourcesManager_UsageWithNotification/CM7/Src/stm32h7xx_it.c          Interrupt handlers for Cortex-M7
    - ResourcesManager/ResourcesManager_UsageWithNotification/CM7/Src/main.c                  Main program for Cortex-M7

    - ResourcesManager/ResourcesManager_UsageWithNotification/CM4/Inc/stm32h7xx_hal_conf.h    HAL configuration file for Cortex-M4
    - ResourcesManager/ResourcesManager_UsageWithNotification/CM4/Inc/stm32h7xx_it.h          Interrupt handlers header file for Cortex-M4
    - ResourcesManager/ResourcesManager_UsageWithNotification/CM4/Inc/main.h                  Header for main.c module for Cortex-M4  
    - ResourcesManager/ResourcesManager_UsageWithNotification/CM4/Src/stm32h7xx_it.c          Interrupt handlers for Cortex-M4
    - ResourcesManager/ResourcesManager_UsageWithNotification/CM4/Src/main.c                  Main program for Cortex-M4
...
@par Hardware and Software environment
  ...
  - This application has been tested with STM32H747I_DISCO  board with SMPS (SD Converter) power supply config and can be
