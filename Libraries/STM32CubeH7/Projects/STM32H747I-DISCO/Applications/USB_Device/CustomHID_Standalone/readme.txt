...
enumerated as a HID compliant device using the native PC Host HID driver to which the STM32H747I_Discovery
board is connected.
...
To test the application, user must proceed as follows:
 ...
 - Select "use SET_FEATURE" or "use SET_REPORT" in order to use SET_REPORT request to send HID Report
   for LED control
 - Use the potentiometer of the STM32H747I_Discovery board to transfer the result of the converted voltage
 ...
 - Select LEDs to switch on/off on the STM32H747I_Discovery board: a SET_REPORT request will be sent
