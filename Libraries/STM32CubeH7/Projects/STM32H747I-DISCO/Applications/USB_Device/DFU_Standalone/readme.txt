...
@note After each device reset, hold down the Key button on the discovery board to enter the DFU mode.
...
In order to make the program work, you must do the following :
 ...
 - In the workspace toolbar select the project configuration:
   - STM32H747I-Discovery_USBH-HS: to configure the project for stm32h7xx devices using USB OTG HS peripheral
 - To run the application, proceed as follows:
   ...
   * With "DfuSe Demonstrator":
    ...
    - Open "DfuSe Demo" and download the "STM32H747I_Discovery_USBD-HS_0x08020000.dfu" provided in Binary directory.
   ...
   * With "STM32CubeProgrammer":
    ...
    - Download the "STM32H747I_Discovery_USBD-HS_0x08020000.bin" provided in Binary directory and set the start address.
