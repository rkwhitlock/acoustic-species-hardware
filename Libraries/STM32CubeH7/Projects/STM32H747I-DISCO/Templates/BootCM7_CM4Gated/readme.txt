/**
  @page Templates  Description of the Templates BootCM7_CM4Gated example

  @verbatim
  ******************************************************************************
  * @file    Templates/BootCM7_CM4Gated/readme.txt
...
where both cores are used. It is mainly dedicated for parts where CPU1 (Cortex-M7) is booting and CPU2(Cortex-M4)clock is gated.
...
@par Directory contents
  ...
  - Templates/BootCM7_CM4Gated/Common/Src/system_stm32h7xx.c     STM32H7xx system configuration file

  - Templates/BootCM7_CM4Gated/CM7/Src/main.c                 Main program for Cortex-M7
  - Templates/BootCM7_CM4Gated/CM7/Src/stm32h7xx_it.c         Interrupt handlers for Cortex-M7
  - Templates/BootCM7_CM4Gated/CM7/Src/stm32h7xx_hal_msp.c    HAL MSP module for Cortex-M7
  - Templates/BootCM7_CM4Gated/CM7/Inc/main.h                 Main program header file for Cortex-M7
  - Templates/BootCM7_CM4Gated/CM7/Inc/stm32h7xx_hal_conf.h   HAL Configuration file for Cortex-M7
  - Templates/BootCM7_CM4Gated/CM7/Inc/stm32h7xx_it.h         Interrupt handlers header file for Cortex-M7

  - Templates/BootCM7_CM4Gated/CM4/Src/main.c                 Main program for Cortex-M4
  - Templates/BootCM7_CM4Gated/CM4/Src/stm32h7xx_it.c         Interrupt handlers for Cortex-M4
  - Templates/BootCM7_CM4Gated/CM4/Src/stm32h7xx_hal_msp.c    HAL MSP module for Cortex-M4
  - Templates/BootCM7_CM4Gated/CM4/Inc/main.h                 Main program header file for Cortex-M4
  - Templates/BootCM7_CM4Gated/CM4/Inc/stm32h7xx_hal_conf.h   HAL Configuration file for Cortex-M4
  - Templates/BootCM7_CM4Gated/CM4/Inc/stm32h7xx_it.h         Interrupt handlers header file for Cortex-M4
...
In order to make the program work, you must do the following :
 ...
 - For each target configuration (STM32H747I_DISCO_CM4 first then STM32H747I_DISCO_CM7) :
     - Rebuild all files
- For STM32H747I_DISCO_CM7 target configuration:
     - Load CM7 image into target memory (CM4 image is included in a section of the CM7 output hex file)

- Run the STM32H747I_DISCO_CM7 target configuration : the CM7 will release the CM4 boot.
