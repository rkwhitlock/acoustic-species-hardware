...
In order to make the program work, you must do the following :
 ...
 - For each target configuration (STM32H747I_DISCO_CM7 first then STM32H747I_DISCO_CM4) :
     - Rebuild all files
- For  STM32H747I_DISCO_CM4 target configuration:
     - Load CM4 image into target memory (CM7 image is included in a section of the CM4 output hex file)

- Run the STM32H747I_DISCO_CM4 target configuration : the CM4 will release the CM7 boot.
