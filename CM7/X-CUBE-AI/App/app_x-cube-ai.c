...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_TINYAUDIOCNN_MODEL_NAME,
        .config = AI_TINYAUDIOCNN_DATA_CONFIG,
        .ai_get_report = ai_tinyaudiocnn_get_report,
        .ai_create = ai_tinyaudiocnn_create,
        .ai_destroy = ai_tinyaudiocnn_destroy,
        .ai_get_error = ai_tinyaudiocnn_get_error,
        .ai_init = ai_tinyaudiocnn_init,
        .ai_run = ai_tinyaudiocnn_run,
        .ai_forward = ai_tinyaudiocnn_forward,
        .ai_data_params_get = ai_tinyaudiocnn_data_params_get,
