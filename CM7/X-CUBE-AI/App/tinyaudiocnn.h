/**
  ...
  ******************************************************************************
  */
#ifndef AI_TINYAUDIOCNN_H
#define AI_TINYAUDIOCNN_H

#include "tinyaudiocnn_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_TINYAUDIOCNN_MODEL_NAME          "tinyaudiocnn"
#define AI_TINYAUDIOCNN_ORIGIN_MODEL_NAME   "buow_tinycnn3_int8"

/******************************************************************************/
#define AI_TINYAUDIOCNN_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TINYAUDIOCNN_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TINYAUDIOCNN_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TINYAUDIOCNN_IN_NUM        (1)

AI_DEPRECATED
#define AI_TINYAUDIOCNN_IN \
  ai_tinyaudiocnn_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TINYAUDIOCNN_IN_SIZE { \
  AI_TINYAUDIOCNN_IN_1_SIZE, \
}
#define AI_TINYAUDIOCNN_IN_SIZE_BYTES { \
  AI_TINYAUDIOCNN_IN_1_SIZE_BYTES, \
}
#define AI_TINYAUDIOCNN_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TINYAUDIOCNN_IN_1_HEIGHT      (1)
#define AI_TINYAUDIOCNN_IN_1_WIDTH       (64)
#define AI_TINYAUDIOCNN_IN_1_CHANNEL     (258)
#define AI_TINYAUDIOCNN_IN_1_SIZE        (16512)
#define AI_TINYAUDIOCNN_IN_1_SIZE_BYTES  (66048)

/******************************************************************************/
#define AI_TINYAUDIOCNN_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TINYAUDIOCNN_OUT \
  ai_tinyaudiocnn_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TINYAUDIOCNN_OUT_SIZE { \
  AI_TINYAUDIOCNN_OUT_1_SIZE, \
}
#define AI_TINYAUDIOCNN_OUT_SIZE_BYTES { \
  AI_TINYAUDIOCNN_OUT_1_SIZE_BYTES, \
}
#define AI_TINYAUDIOCNN_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_TINYAUDIOCNN_OUT_1_CHANNEL     (6)
#define AI_TINYAUDIOCNN_OUT_1_SIZE        (6)
#define AI_TINYAUDIOCNN_OUT_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_TINYAUDIOCNN_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup tinyaudiocnn
 ...
 * @ref ai_tinyaudiocnn_create. Both the activations memory buffer 
 ...
 * using @ref ai_tinyaudiocnn_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tinyaudiocnn_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_tinyaudiocnn_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TINYAUDIOCNN_*
 * defines into file @ref tinyaudiocnn.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_tinyaudiocnn_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_TINYAUDIOCNN_H */
