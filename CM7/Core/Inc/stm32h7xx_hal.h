...
#define SYSCFG_VREFBUF_VOLTAGE_SCALE0                                                              \
    VREFBUF_CSR_VRS_OUT1 /*!< Voltage reference scale 0 (VREF_OUT1) */
#define SYSCFG_VREFBUF_VOLTAGE_SCALE1                                                              \
    VREFBUF_CSR_VRS_OUT2 /*!< Voltage reference scale 1 (VREF_OUT2) */
#define SYSCFG_VREFBUF_VOLTAGE_SCALE2                                                              \
    VREFBUF_CSR_VRS_OUT3 /*!< Voltage reference scale 2 (VREF_OUT3) */
#define SYSCFG_VREFBUF_VOLTAGE_SCALE3                                                              \
    VREFBUF_CSR_VRS_OUT4 /*!< Voltage reference scale 3 (VREF_OUT4) */
...
#define SYSCFG_VREFBUF_HIGH_IMPEDANCE_DISABLE                                                      \
    ((uint32_t)0x00000000) /*!< VREF_plus pin is internally connected to Voltage reference buffer  \
                              output */
...
#define IS_SYSCFG_VREFBUF_TRIMMING(__VALUE__)                                                      \
    (((__VALUE__) > 0UL) && ((__VALUE__) <= VREFBUF_CCR_TRIM))
...
#define SYSCFG_ADC2_ROUT1_DAC1_2 ((uint32_t)0x00000000) /*!< DAC1_out2 connected to ADC2 VINP[17]  \
                                                         */
#define SYSCFG_ADC2_ROUT1_VREFINT                                                                  \
    SYSCFG_ADC2ALT_ADC2_ROUT1 /*!< VREFINT connected to ADC2 VINP[17] */

#define IS_SYSCFG_ADC2ALT_ROUT0(__VALUE__)                                                         \
    (((__VALUE__) == SYSCFG_ADC2_ROUT0_DAC1_1) || ((__VALUE__) == SYSCFG_ADC2_ROUT0_VBAT4))
#define IS_SYSCFG_ADC2ALT_ROUT1(__VALUE__)                                                         \
    (((__VALUE__) == SYSCFG_ADC2_ROUT1_DAC1_2) || ((__VALUE__) == SYSCFG_ADC2_ROUT1_VREFINT))
...
#define SYSCFG_ETH_RMII                                                                            \
    SYSCFG_PMCR_EPIS_SEL_2 /*!< Select the Reduced Media Independent Interface */
...
#define IS_SYSCFG_BOOT_REGISTER(REGISTER)                                                          \
    (((REGISTER) == SYSCFG_BOOT_ADDR0) || ((REGISTER) == SYSCFG_BOOT_ADDR1))
...
#define SYSCFG_REGISTER_CODE                                                                       \
    SYSCFG_CCCSR_CS /*!< Code from the SYSCFG compensation cell code register */

#define IS_SYSCFG_CODE_SELECT(SELECT)                                                              \
    (((SELECT) == SYSCFG_CELL_CODE) || ((SELECT) == SYSCFG_REGISTER_CODE))
...
#define IS_HAL_EXTI_CONFIG_LINE(LINE)                                                              \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) ||                 \
     ...
     ((LINE) == EXTI_LINE18) || ((LINE) == EXTI_LINE19) || ((LINE) == EXTI_LINE20) ||              \
     ((LINE) == EXTI_LINE21) || ((LINE) == EXTI_LINE49) || ((LINE) == EXTI_LINE51) ||              \
     ((LINE) == EXTI_LINE82) || ((LINE) == EXTI_LINE84) || ((LINE) == EXTI_LINE85) ||              \
     ((LINE) == EXTI_LINE86))
#else
#define IS_HAL_EXTI_CONFIG_LINE(LINE)                                                              \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) ||                 \
...
#define IS_EXTI_ALL_LINE(LINE)                                                                     \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) ||                 \
     ...
     ((LINE) == EXTI_LINE15) || ((LINE) == EXTI_LINE16) || ((LINE) == EXTI_LINE17) ||              \
     ((LINE) == EXTI_LINE18) || ((LINE) == EXTI_LINE19) || ((LINE) == EXTI_LINE20) ||              \
     ((LINE) == EXTI_LINE21) || ((LINE) == EXTI_LINE22) || ((LINE) == EXTI_LINE23) ||              \
     ((LINE) == EXTI_LINE24) || ((LINE) == EXTI_LINE25) || ((LINE) == EXTI_LINE26) ||              \
     ((LINE) == EXTI_LINE27) || ((LINE) == EXTI_LINE28) || ((LINE) == EXTI_LINE29) ||              \
     ((LINE) == EXTI_LINE30) || ((LINE) == EXTI_LINE31) || ((LINE) == EXTI_LINE32) ||              \
     ((LINE) == EXTI_LINE33) || ((LINE) == EXTI_LINE34) || ((LINE) == EXTI_LINE35) ||              \
     ((LINE) == EXTI_LINE36) || ((LINE) == EXTI_LINE37) || ((LINE) == EXTI_LINE38) ||              \
     ((LINE) == EXTI_LINE39) || ((LINE) == EXTI_LINE40) || ((LINE) == EXTI_LINE41) ||              \
     ((LINE) == EXTI_LINE42) || ((LINE) == EXTI_LINE43) || ((LINE) == EXTI_LINE44) ||              \
     ((LINE) == EXTI_LINE46) || ((LINE) == EXTI_LINE47) || ((LINE) == EXTI_LINE48) ||              \
     ((LINE) == EXTI_LINE49) || ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) ||              \
     ((LINE) == EXTI_LINE52) || ((LINE) == EXTI_LINE53) || ((LINE) == EXTI_LINE54) ||              \
     ((LINE) == EXTI_LINE55) || ((LINE) == EXTI_LINE56) || ((LINE) == EXTI_LINE57) ||              \
     ((LINE) == EXTI_LINE58) || ((LINE) == EXTI_LINE59) || ((LINE) == EXTI_LINE60) ||              \
     ((LINE) == EXTI_LINE61) || ((LINE) == EXTI_LINE62) || ((LINE) == EXTI_LINE63) ||              \
     ((LINE) == EXTI_LINE64) || ((LINE) == EXTI_LINE65) || ((LINE) == EXTI_LINE66) ||              \
     ((LINE) == EXTI_LINE67) || ((LINE) == EXTI_LINE68) || ((LINE) == EXTI_LINE69) ||              \
     ((LINE) == EXTI_LINE70) || ((LINE) == EXTI_LINE71) || ((LINE) == EXTI_LINE72) ||              \
     ((LINE) == EXTI_LINE73) || ((LINE) == EXTI_LINE74) || ((LINE) == EXTI_LINE75) ||              \
     ((LINE) == EXTI_LINE76) || ((LINE) == EXTI_LINE77) || ((LINE) == EXTI_LINE79) ||              \
     ((LINE) == EXTI_LINE84) || ((LINE) == EXTI_LINE85) || ((LINE) == EXTI_LINE86) ||              \
     ((LINE) == EXTI_LINE87) || ((LINE) == EXTI_LINE78) || ((LINE) == EXTI_LINE80) ||              \
     ((LINE) == EXTI_LINE82))
#else
#define IS_EXTI_ALL_LINE(LINE)                                                                     \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) ||                 \
     ...
     ((LINE) == EXTI_LINE39) || ((LINE) == EXTI_LINE40) || ((LINE) == EXTI_LINE41) ||              \
     ((LINE) == EXTI_LINE42) || ((LINE) == EXTI_LINE43) || ((LINE) == EXTI_LINE44) ||              \
     ((LINE) == EXTI_LINE47) || ((LINE) == EXTI_LINE48) || ((LINE) == EXTI_LINE49) ||              \
     ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) || ((LINE) == EXTI_LINE52) ||              \
     ((LINE) == EXTI_LINE53) || ((LINE) == EXTI_LINE54) || ((LINE) == EXTI_LINE55) ||              \
     ((LINE) == EXTI_LINE56) || ((LINE) == EXTI_LINE57) || ((LINE) == EXTI_LINE58) ||              \
     ((LINE) == EXTI_LINE59) || ((LINE) == EXTI_LINE60) || ((LINE) == EXTI_LINE61) ||              \
     ((LINE) == EXTI_LINE62) || ((LINE) == EXTI_LINE63) || ((LINE) == EXTI_LINE64) ||              \
     ((LINE) == EXTI_LINE65) || ((LINE) == EXTI_LINE66) || ((LINE) == EXTI_LINE67) ||              \
     ((LINE) == EXTI_LINE68) || ((LINE) == EXTI_LINE69) || ((LINE) == EXTI_LINE70) ||              \
     ((LINE) == EXTI_LINE71) || ((LINE) == EXTI_LINE72) || ((LINE) == EXTI_LINE73) ||              \
     ((LINE) == EXTI_LINE74) || ((LINE) == EXTI_LINE75) || ((LINE) == EXTI_LINE76) ||              \
     ((LINE) == EXTI_LINE85) || ((LINE) == EXTI_LINE86) || ((LINE) == EXTI_LINE87) ||              \
     ((LINE) == EXTI_LINE88) || ((LINE) == EXTI_LINE89) || ((LINE) == EXTI_LINE90) ||              \
     ((LINE) == EXTI_LINE91))
#endif /*DUAL_CORE*/
...
#define IS_EXTI_D2_LINE(LINE)                                                                      \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) ||                 \
     ...
     ((LINE) == EXTI_LINE70) || ((LINE) == EXTI_LINE71) || ((LINE) == EXTI_LINE72) ||              \
     ((LINE) == EXTI_LINE73) || ((LINE) == EXTI_LINE74) || ((LINE) == EXTI_LINE75) ||              \
     ((LINE) == EXTI_LINE76) || ((LINE) == EXTI_LINE78) || ((LINE) == EXTI_LINE80) ||              \
     ((LINE) == EXTI_LINE82) || ((LINE) == EXTI_LINE85) || ((LINE) == EXTI_LINE86) ||              \
     ((LINE) == EXTI_LINE87))
#endif /*DUAL_CORE*/
...
#define IS_EXTI_D3_LINE(LINE)                                                                      \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) ||                 \
     ...
     ((LINE) == EXTI_LINE9) || ((LINE) == EXTI_LINE10) || ((LINE) == EXTI_LINE11) ||               \
     ((LINE) == EXTI_LINE12) || ((LINE) == EXTI_LINE13) || ((LINE) == EXTI_LINE14) ||              \
     ((LINE) == EXTI_LINE15) || ((LINE) == EXTI_LINE19) || ((LINE) == EXTI_LINE20) ||              \
     ((LINE) == EXTI_LINE21) || ((LINE) == EXTI_LINE25) || ((LINE) == EXTI_LINE34) ||              \
     ((LINE) == EXTI_LINE35) || ((LINE) == EXTI_LINE41) || ((LINE) == EXTI_LINE48) ||              \
     ((LINE) == EXTI_LINE49) || ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) ||              \
     ((LINE) == EXTI_LINE52) || ((LINE) == EXTI_LINE53))
...
#define IS_EXTI_D3_LINE(LINE)                                                                      \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) ||                 \
     ...
     ((LINE) == EXTI_LINE35) || ((LINE) == EXTI_LINE41) || ((LINE) == EXTI_LINE48) ||              \
     ((LINE) == EXTI_LINE49) || ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) ||              \
     ((LINE) == EXTI_LINE52) || ((LINE) == EXTI_LINE53) || ((LINE) == EXTI_LINE88))
#else
#define IS_EXTI_D3_LINE(LINE)                                                                      \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) ||                 \
     ((LINE) == EXTI_LINE3) || ((LINE) == EXTI_LINE4) || ((LINE) == EXTI_LINE5) ||                 \
...
#define BDMA_CH6_CLEAR                                                                             \
    ((uint32_t)0x00000000) /*!< BDMA ch6 event selected as D3 domain pendclear source*/
#define BDMA_CH7_CLEAR                                                                             \
    ((uint32_t)0x00000001) /*!< BDMA ch7 event selected as D3 domain pendclear source*/
#if defined(LPTIM4)
#define LPTIM4_OUT_CLEAR                                                                           \
    ((uint32_t)0x00000002) /*!< LPTIM4 out selected as D3 domain pendclear source*/
#else
#define LPTIM2_OUT_CLEAR                                                                           \
    ((uint32_t)0x00000002) /*!< LPTIM2 out selected as D3 domain pendclear source*/
#endif                     /* LPTIM4 */
#if defined(LPTIM5)
#define LPTIM5_OUT_CLEAR                                                                           \
    ((uint32_t)0x00000003) /*!< LPTIM5 out selected as D3 domain pendclear source*/
#else
#define LPTIM3_OUT_CLEAR                                                                           \
    ((uint32_t)0x00000003) /*!< LPTIM3 out selected as D3 domain pendclear source*/
#endif                     /* LPTIM5 */
...
#define IS_FMC_SWAPBMAP_MODE(__MODE__)                                                             \
    (((__MODE__) == FMC_SWAPBMAP_DISABLE) || ((__MODE__) == FMC_SWAPBMAP_SDRAM_SRAM) ||            \
 ...
 */
#define __HAL_ART_CONFIG_BASE_ADDRESS(__BASE_ADDRESS__)                                            \
    MODIFY_REG(ART->CTR, ART_CTR_PCACHEADDR, (((__BASE_ADDRESS__) >> 12U) & 0x000FFF00UL))
...
/** @brief  SYSCFG Break AXIRAM double ECC lock.
  *         Enable and lock the connection of AXIRAM double ECC error to TIM1/8/15/16/17 and HRTIMER
  Break input.
...
/** @brief  SYSCFG Break ITCM double ECC lock.
  *         Enable and lock the connection of ITCM double ECC error to TIM1/8/15/16/17 and HRTIMER
  Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break DTCM double ECC lock.
  *         Enable and lock the connection of DTCM double ECC error to TIM1/8/15/16/17 and HRTIMER
  Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break SRAM1 double ECC lock.
  *         Enable and lock the connection of SRAM1 double ECC error to TIM1/8/15/16/17 and HRTIMER
  Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break SRAM2 double ECC lock.
  *         Enable and lock the connection of SRAM2 double ECC error to TIM1/8/15/16/17 and HRTIMER
  Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break SRAM3 double ECC lock.
  *         Enable and lock the connection of SRAM3 double ECC error to TIM1/8/15/16/17 and HRTIMER
  Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break SRAM4 double ECC lock.
  *         Enable and lock the connection of SRAM4 double ECC error to TIM1/8/15/16/17 and HRTIMER
  Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break Backup SRAM double ECC lock.
  *         Enable and lock the connection of Backup SRAM double ECC error to TIM1/8/15/16/17 and
  HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break Cortex-M7 Lockup lock.
  *         Enable and lock the connection of Cortex-M7 LOCKUP output to TIM1/8/15/16/17 and HRTIMER
  Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break FLASH double ECC lock.
  *         Enable and lock the connection of Flash double ECC error connection to TIM1/8/15/16/17
  and HRTIMER Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
/** @brief  SYSCFG Break PVD lock.
  *         Enable and lock the PVD connection to Timer1/8/15/16/17 and HRTIMER Break input, as well
...
/** @brief  SYSCFG Break Cortex-M4 Lockup lock.
  *         Enable and lock the connection of Cortex-M4 LOCKUP output to TIM1/8/15/16/17 and HRTIMER
  Break input.
  * @note   The selected configuration is locked and can be unlocked only by system reset.
            This feature is available on STM32H7 rev.B and above.
  */
...
#define IS_TICKFREQ(FREQ)                                                                          \
    ...
    void HAL_SYSCFG_VDDMMC_CompensationCodeConfig(uint32_t SYSCFG_PMOSCode,
...
#if defined(DUAL_CORE)
    void HAL_EXTI_D2_EventInputConfig(uint32_t EXTI_Line, uint32_t EXTI_Mode,
                                      uint32_t EXTI_LineCmd);
#endif /*DUAL_CORE*/
